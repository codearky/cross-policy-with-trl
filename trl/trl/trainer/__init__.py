...
_import_structure = {
    ...
    "cross_policy_grpo_config": ["CrossPolicyGRPOConfig"],
    "cross_policy_grpo_trainer": ["CrossPolicyGRPOTrainer"],
...
if TYPE_CHECKING:
    ...
    from .cross_policy_grpo_trainer import CrossPolicyGRPOTrainer
